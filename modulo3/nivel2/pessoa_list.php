        ...
        <tbody>
            <?php
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    print '<tr>';
                    print "<td><a href='pessoa_form.php?action=edit&id={$id}'><img src='./images/edit.png' style='width: 17px'/></a></td>";
                    print "<td><a href='pessoa_list.php?action=delete&id={$id}'><img src='./images/delete.png' style='width: 17px'/></a></td>";
                    print "<td>{$id}</td>";
                    print "<td>{$nome}</td>";
